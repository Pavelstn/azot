...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { active: @type.active, aliasname: @type.aliasname, name: @type.name, order: @type.order }
    end
  ...
  test "should update type" do
    put :update, id: @type, type: { active: @type.active, aliasname: @type.aliasname, name: @type.name, order: @type.order }
    assert_redirected_to type_path(assigns(:type))
  end
