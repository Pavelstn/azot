...
ActiveRecord::Schema.define(:version => 20130602104503) do
  ...
  create_table "deals", :force => true do |t|
    ...
    t.datetime "created_at",                                          :null => false
    t.datetime "updated_at",                                          :null => false
    t.boolean  "vkpost",                           :default => false
    t.boolean  "twitterpost",                      :default => false
    t.boolean  "fkubankpost",                      :default => false
  end
